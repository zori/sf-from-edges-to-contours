...
dataVPRnormTs=[... % VPR normalised on the side of the trees
  struct('out','Output_segs_VPR_normalised_trees','legend','s. VPR norm Ts','style',{{'Marker','x'}}),...
  struct('out','Output_line_VPR_normalised_trees','legend','line VPR norm Ts','style',{{'Marker','x'}}),...
  struct('out','Output_fairer_merge_VPR_normalised_trees','legend','region bdry fairer s. VPR norm Ts','style',{{'Marker','x'}}),...
  ];
dataOracleVPRnormTs=[...
  struct('out','Output_oracle_fairer_merge_VPR_normalised_trees','legend','o. region bdry fairer s. VPR norm Ts','style',{{'Marker','x'}}),...
  ];
...
dataAllOracle=[dataOracleSimple,dataOracleVPRnormWS,dataOracleVPRnormTs,dataOracleBPR,dataOracleContourBpr];

dataOurs=[dataVPRnormTs,dataOracleVPRnormTs];
...
data_fairer_merge=[...
  struct('out','Output_fairer_merge_VPR_normalised_ws','legend','region bdry fairer s. VPR norm ws','style',{{'Marker','x'}}),...
  struct('out','Output_fairer_merge_VPR_normalised_trees','legend','region bdry fairer s. VPR norm Ts','style',{{'Marker','x'}}),...
  struct('out','Output_fairer_merge_RI','legend','region bdry fairer s. RI','style',{{'Marker','x'}}),...
  struct('out','Output_fairer_merge_RIMC','legend','region bdry fairer s. RIMC','style',{{'Marker','x'}}),...
  struct('out','Output_oracle_fair_segs_VPR_normalised_ws','legend','REPEAT: o. fs. VPR norm ws','style',{{'LineStyle','-.','Marker','x'}}),... % old
  struct('out','Output_oracle_fairer_merge_VPR_normalised_ws','legend','o. region bdry fairer s. VPR norm ws','style',{{'Marker','x'}}),...
  struct('out','Output_oracle_fairer_merge_VPR_normalised_trees','legend','o. region bdry fairer s. VPR norm Ts','style',{{'Marker','x'}}),...
  struct('out','Output_oracle_fairer_merge_RI','legend','o. region bdry fairer s. RI','style',{{'Marker','x'}}),...
  struct('out','Output_oracle_fairer_merge_RIMC','legend','o. region bdry fairer s. RIMC','style',{{'Marker','x'}}),...
];

dataOurs=data_fairer_merge;
% TODO add a baseline
