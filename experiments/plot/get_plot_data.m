...
data_SF_ucm_new_baseline=[... % new baseline - evaluate SF on a pixel (or smaller patch); rescaled ucm2s
  ...
  struct('out','Output_ucm_bdry_sz_1_ul_16x16_orig_rescaled','legend','16x16=orig rescaled','style',{{'Marker','x'}}),...
];
...
dataOurs=data_SF_ucm_new_baseline;
