...
data=struct('outDir',{'Output_srf_dollar','Output_bsds_downloaded','Output_df_vanilla_watershed_over-seg','Output_df_ucm','Output_df_and_sPb','Output_mcg_downloaded'},...
  'legend',{'DF structured edge','BSDS','DF watershed over-segmentation','UCM','DF + sPb','MCG'},...
  'color',{'g','y','b','m','r.','c'});
