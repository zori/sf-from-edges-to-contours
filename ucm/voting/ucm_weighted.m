...
% Jul 2014
% 8.3.0.532 (R2014a)
function ucm2 = ucm_weighted(I,model,voting,fmt,varargin)
% function ucm2 = ucm_weighted(I,model,voting,fmt,T,gts)
...
[cfp_fcn,E]=get_voting_fcn(I,model,voting,varargin{:});
