...
% Feb 2015
% 8.3.0.532 (R2014a)
function [sf_wt,votes,vote_fcn,c] = create_finest_partition_mixed_voting_scope(pb,vote_fcn,DBG)
...
% remove empty fields
c_subdivided=rmfield(c_subdivided,{'edge_equiv_ids','regions_v_left','regions_v_right','regions_e_left','regions_e_right','regions_c_left','regions_c_right'});
