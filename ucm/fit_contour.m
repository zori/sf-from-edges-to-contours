...
function contours = fit_contour(nmax,subdivide)  %#ok<INUSL>
if ~exist('subdivide','var'), subdivide=true; end % default is behaviour from Arbelaez et al.
% extract contours
...
if subdivide
  ...
  [~, skel, labels, is_v, is_e, assign, vertices, edges, ...
    v_left, v_right, e_left, e_right, c_left, c_right, ...
    edge_equiv_ids, is_compl, e_x_coords, e_y_coords] = ...
    evalc('mex_contour_sides_new(nmax,true)');
end
